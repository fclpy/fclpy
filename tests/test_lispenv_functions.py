...
EXPECTED_LISP_FUNCTIONS = [
    ...
    'DO','DOLIST','DOTIMES','EVAL-WHEN','LOAD','EQUALP','NOT','EQL','EQUAL','DO-SYMBOLS','DO-EXTERNAL-SYMBOLS','DO-ALL-SYMBOLS','DOCUMENTATION','PI','LEAST-POSITIVE-DOUBLE-FLOAT','LEAST-NEGATIVE-DOUBLE-FLOAT','MOST-POSITIVE-DOUBLE-FLOAT','MOST-NEGATIVE-DOUBLE-FLOAT','EVERY','SOME','NOTEVERY','NOTANY','MAPCAR','MAPC','MAPCAN','MAPL','MAPLIST','APPLY',
